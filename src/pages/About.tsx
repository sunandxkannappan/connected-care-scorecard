...
import { ChevronDown, ChevronUp, Building2, Scale, GraduationCap, Server, Users, Building, Smartphone, BarChart3 } from "lucide-react";
                  ...
                  <div className="min-w-0">
                    ...
                    {"linkedin" in author && author.linkedin && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 font-sans text-xs text-[#0A66C2] hover:underline mt-1.5"
                      >
